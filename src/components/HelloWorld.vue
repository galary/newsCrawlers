<template class="ll">
  <div class="hello" id='hello' ref="beackgroundimg">
    <div class="visible"></div>
    <h1 class="animated zoomInLeft shake">hashahsah</h1>
    <h1 ref='dom1' class="animated zoomInUp wobble">曾梦想仗剑走天涯</h1>
    <h2 ref='dom2' class="animated zoomInUp flipInX">看一看世界的繁华</h2>
    <h2 ref='dom3' class="txtwav flip"> 后来梦想缩了水 欲望也瘪得不像话 风尘仆仆的旅人啊 只想找到一个家</h2>
  </div>
</template>
<script>
...
export default {
  ...
  mounted: function() {
    ...
    // this.$refs.dom1.className = 'animated bounceOutLeft';

  },
  created() {
    document.body.style.background = 'url(../static/img/home.jpg) no-repeat';
