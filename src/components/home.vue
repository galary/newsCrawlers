<template>
  <div class="signIn">
    ...
    <mt-tab-container class="page-tabbar-container" v-model="itemData">
      <mt-tab-container-item id="news">
        <!-- <news-component /> -->
      </mt-tab-container-item>
      <mt-tab-container-item id="imgs">
        <div class="wrap">
          <a href="" class="selectImg" title="上传图片"></a>
          <input type="file" multiple id="file">
          <input type="button" value="上传" id="upload">
          <div class="preview" id="progressImg"></div>
          <div class="progress">
      ...
      <mt-tab-container-item id="me">
        ...
        <router-link to="/home">
          <mt-button type="danger" size="large" @click='ondinji'>退出</mt-button>
        </router-link>
      </mt-tab-container-item>
    </mt-tab-container>
    <mt-footer @getData='change' class="Mt_footer"></mt-footer>
  </div>
</template>
<script>
import Footer from './component/footer.vue'
import newsComponent from './component/news-component.vue'
